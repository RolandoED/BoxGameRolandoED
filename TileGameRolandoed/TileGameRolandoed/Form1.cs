...
namespace TileGameRolandoed
{
    public partial class Form1 : Form
    {
        ...
        public void KickSound() {
            SoundPlayer simpleSound = new SoundPlayer(@"c:\kick.wav");
            simpleSound.Play();
        }

        public void BumpSound()
        {
            SoundPlayer simpleSound = new SoundPlayer(@"c:\bump.wav");
            simpleSound.Play();
        }

        public void WalkSound()
        {
            SoundPlayer simpleSound = new SoundPlayer(@"c:\walk.wav");
            simpleSound.Play();
        }

        public void RestartSound()
        {
            SoundPlayer simpleSound = new SoundPlayer(@"c:\restart.wav");
            simpleSound.Play();
        }
